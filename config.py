class Config:
    ...
    SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://postgres.pavocfhmigmdzrzxoiio:cuvwiN-zosmob-8wonzu@aws-1-eu-west-1.pooler.supabase.com:6543/postgres'
    ...
    # Beveiliging voor de API (alleen software met deze sleutel mag aanpassingen doen)
